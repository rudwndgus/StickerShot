...
export function SettingsPage() {
  ...
  return <main className="page settings-page">
    ...
    <section className="settings-group"><h2>앱 정보</h2><div className="settings-row"><span><i><Smartphone /></i><span><b>현재 버전</b><small>가벼운 기울기와 강한 흔들기</small></span></span><b>1.3.2</b></div></section>
