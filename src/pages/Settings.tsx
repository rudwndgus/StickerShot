...
export function SettingsPage() {
  ...
  return <main className="page settings-page">
    ...
    <section className="settings-group"><h2>앱 정보</h2><div className="settings-row"><span><i><Smartphone /></i><span><b>현재 버전</b><small>내 물건 통 바닥 표시 개선</small></span></span><b>1.3.1</b></div></section>
