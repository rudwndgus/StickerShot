...
export function SettingsPage() {
  ...
  return <main className="page settings-page">
    ...
    <section className="settings-group"><h2>앱 정보</h2><div className="settings-row"><span><i><Smartphone /></i><span><b>현재 버전</b><small>부드럽고 제한된 기울기 중력</small></span></span><b>1.3.3</b></div></section>
